...
import { clearVoxelShader, splatPointsShader, normalizeDensityShader, marchingCubesShader } from './wgsl-shaders.js';
...
export class MeshReconstructor {
   ...
   * @param {Float32Array} colors - 点云颜色数据
   * @param {number} count - 点数量
   * @param {number} gridRes - 网格分辨率
   */
  ...
  /**
   * 执行网格重建
   * @returns {Promise<Object|null>} 包含 positions, normals, colors, triangleCount 的结果对象
   */
  async reconstruct() {
